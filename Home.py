...
st.markdown('<div class="center"><img src="https://cdn-idpgf.nitrocdn.com/TSeLIaDKAUBecatjFLZJpxhTJKErGZRH/assets/images/optimized/rev-4f3053c/insights/wp-content/uploads/2020/11/chatbots.gif" alt="Image" width="150"></div>', unsafe_allow_html=True)
